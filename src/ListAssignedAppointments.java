...
public class ListAssignedAppointments implements ActionListener {
    User currentUser;
    User displayedUser;
    ...
    private void updateAppointmentListAccordingToUser(Repairer r) throws FileNotFoundException, SQLException {
        ...
        Queue<Appointment> allAppointments = r.getAssignedAppointments();
        ...
        appointmentsText
                .setText("<HTML><H1><B><U>" + r.getUsername() + "\'s assigned appointments</U></B></H1></HTML>");
    }

    public ListAssignedAppointments(User user) throws FileNotFoundException, SQLException {
        ...
        applianceTable.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent doubleClick) {
                ...
                if (doubleClick.getClickCount() == 2 && applianceTable.getSelectedRow() != -1) {
                    ...
                    try {
                        new AppointmentInfo(new Appointment((int) applianceTable.getValueAt(row, 0)), currentUser); // TODO:
                        // appointment
                        // info
